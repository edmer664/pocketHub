    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <img class="image-profile rounded-circle img-fluid default-avatar" width="60"
                    ...
                    alt="">
                @else
                <img class="image-profile rounded-circle img-fluid avatar " width="60"
                    src="{{ url('storage/avatars/' . Auth::user()->avatar_path) }}" alt="">
                @endif
                <img class="image-profile rounded-circle img-fluid avatar d-none" width="60"
                    src="{{ url('storage/avatars/' . Auth::user()->avatar_path) }}" alt="">
